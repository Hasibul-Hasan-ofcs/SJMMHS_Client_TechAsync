...
import { AddTeachersAdminAPI } from "../../../API/teachers/AddTeachersAdminAPI";

const AddTeachers = ({ open, handleOpen, refetch }) => {
  ...
  const formSubmitHandler = (e, stname, stdesignation, stphone_number) => {
    ...
    const result = AddTeachersAdminAPI(stname, stdesignation, stphone_number);
  ...
  return (
    <Dialog open={open} handler={handleOpen}>
      ...
      >
        <DialogHeader>Add Teacher Information</DialogHeader>
        <DialogBody>
          <input
            type="text"
            value={stname}

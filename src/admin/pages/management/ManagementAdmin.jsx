...
import AddManagement from "./add_management_modal/AddManagement";
import { Oval } from "react-loader-spinner";
import { DeleteManagementAdminAPI } from "../../API/management/DeleteManagementAdminAPI";

const TABLE_HEAD = ["সিরিয়াল", "নাম", "্পদ", "ফোন", "একশন"];

const ManagementAdmin = () => {
  const { isLoading, refetch, data } = ManagementAPI();
  ...
  return (
    <div className="py-8 px-1">
      <div className="flex items-center justify-center py-10">
        ...
        >
          <FiPlusCircle className="pe-3 text-4xl" /> ADD NEW PERSON DATA
        </Button>
      </div>

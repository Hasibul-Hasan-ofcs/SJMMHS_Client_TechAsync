...
import AddNotice from "./add_notice_modal/AddNotice";
import { DeleteNoticeAdminAPI } from "../../API/notice/DeleteNoticeAdminAPI";

const TABLE_HEAD = ["সিরিয়াল", "তারিখ", "নোটিশ", "একশন"];

const NoticeAdmin = () => {
  const { isLoading, refetch, data } = NoticeAPI();
  ...
  return (
    <div className="py-8 pe-6">
      <div className="flex items-center justify-center py-10">
        ...
        >
          <FiPlusCircle className="pe-3 text-4xl" /> ADD NEW NOTICE
        </Button>
      </div>

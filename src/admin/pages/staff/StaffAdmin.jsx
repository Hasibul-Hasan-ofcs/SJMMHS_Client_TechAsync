...
import AddStaff from "./add_staff_modal/AddStaff";
import { DeleteStaffAdminAPI } from "../../API/staff/DeleteStaffAdminAPI";
import Swal from "sweetalert2";

const TABLE_HEAD = ["সিরিয়াল", "নাম", "্পদ", "ফোন", "একশন"];

const StaffAdmin = () => {
  const { isLoading, refetch, data } = StaffAPI();
  ...
  return (
    <div className="py-8 px-1">
      <div className="flex items-center justify-center py-10">
        ...
        >
          <FiPlusCircle className="pe-3 text-4xl" /> ADD NEW PERSON
        </Button>
      </div>
